...
export const HERRAMIENTAS: Herramienta[] = [
  ...
  {
    slug: 'anonimizar-pdf',
    nombre: 'Anonimizar PDF',
    descripcion: 'Busca DNI, teléfonos, correos o cuentas y los borra del documento entero.',
    icono: 'bi-eye-slash',
    categoria: 'PDF',
    acepta: '.pdf',
    varios: false,
    palabras: ['tachar', 'ocultar', 'censurar', 'redactar', 'datos personales', 'dni',
               'iban', 'rgpd', 'proteccion de datos', 'privacidad'],
    disponible: true,
  },
  {
    slug: 'ocr-pdf',
  ...
  {
    slug: 'pdf-a-pdfa',
    nombre: 'Convertir a PDF/A',
    descripcion: 'Deja el PDF en el formato de archivado que piden las sedes y los registros.',
    icono: 'bi-archive',
    categoria: 'PDF',
    acepta: '.pdf',
    varios: true,
    palabras: ['pdfa', 'pdf/a', 'archivado', 'administracion', 'sede electronica', 'registro',
               'juzgado', 'preservacion', 'norma', '1b', '2b'],
    disponible: true,
  },
  {
    slug: 'pdf-a-grises',
    nombre: 'PDF en escala de grises',
    descripcion: 'Quita el color del documento para imprimirlo sin gastar tinta de color.',
    icono: 'bi-circle-half',
    categoria: 'PDF',
    acepta: '.pdf',
    varios: true,
    palabras: ['grises', 'gris', 'blanco y negro', 'byn', 'b/n', 'sin color', 'imprimir', 'tinta',
               'monocromo'],
    disponible: true,
  },
  {
    ...
    descripcion: 'Reduce el peso del documento, o déjalo por debajo del tamaño que te piden.',
  ...
  },
  {
    ...
    descripcion: 'Recorta, gira y cambia de tamaño una foto sin abrir un editor.',
    icono: 'bi-crop',
    categoria: 'Imágenes',
    acepta: 'image/*',
    varios: false,
    palabras: ['recortar', 'crop', 'girar', 'rotar', 'redimensionar', 'tamaño', 'voltear',
               'espejo', 'cuadrada', 'proporcion'],
    disponible: true,
  },
  {
    slug: 'efecto-escaner',
    nombre: 'Efecto escáner',
    descripcion: 'Quita la sombra y el fondo gris de la foto de un papel, como un escáner.',
    icono: 'bi-eraser',
    categoria: 'Imágenes',
    acepta: 'image/*',
    varios: true,
    palabras: ['escanear', 'escaner', 'foto de documento', 'sombra', 'contraste', 'blanquear',
               'limpiar', 'umbral', 'ocr'],
    disponible: true,
  },
  {
  ...
  },
  {
    ...
    descripcion: 'Convierte Word, Excel, PowerPoint u OpenDocument a PDF conservando el formato.',
    icono: 'bi-filetype-pdf',
    categoria: 'Documentos',
    acepta: '.docx,.doc,.odt,.rtf,.txt,.xlsx,.xls,.ods,.pptx,.ppt,.odp',
    varios: true,
    palabras: ['word a pdf', 'docx', 'odt', 'rtf', 'convertir', 'exportar', 'excel a pdf',
               'xlsx', 'hoja de calculo', 'powerpoint a pdf', 'pptx', 'presentacion', 'diapositivas'],
    disponible: true,
  },
  {
    slug: 'pdf-a-word',
  ...
  {
    slug: 'extraer-tablas',
    nombre: 'Extraer tablas',
    descripcion: 'Saca a Excel o a CSV las tablas de un PDF, con los importes ya como números.',
    icono: 'bi-table',
    categoria: 'Documentos',
    acepta: '.pdf',
    varios: false,
    palabras: ['excel', 'xlsx', 'csv', 'hoja de calculo', 'factura', 'balance', 'listado',
               'datos', 'tabla'],
    disponible: true,
  },
  {
    ...
    descripcion: 'Pasa un PDF, Word, Excel, PowerPoint o correo a Markdown para dárselo a una IA.',
    icono: 'bi-markdown',
    categoria: 'Documentos',
    acepta: '.pdf,.docx,.xlsx,.xls,.pptx,.csv,.json,.xml,.html,.htm,.txt,.md,.epub,.eml,.msg',
    varios: true,
  ...
  },
  {
    ...
    acepta: '.eml,.msg',
    varios: true,
    palabras: ['correo', 'email', 'eml', 'mensaje', 'outlook', 'thunderbird', 'gmail',
               'adjuntos', 'imprimir', 'guardar'],
    disponible: true,
  },
  {
  ...
  {
    slug: 'leer-codigo',
    nombre: 'Leer QR o código de barras',
    descripcion: 'Saca lo que pone dentro de un código, desde un pantallazo, una foto o un PDF.',
    icono: 'bi-upc-scan',
    categoria: 'Imágenes',
    acepta: '.pdf,image/*',
    varios: true,
    palabras: ['qr', 'escanear', 'decodificar', 'leer', 'codigo de barras', 'ean', 'wifi',
               'barcode', 'datamatrix'],
    disponible: true,
  },
  {
    ...
    descripcion: 'Pasa entre JPG, PNG, WebP y otros formatos, incluido el HEIC del móvil.',
